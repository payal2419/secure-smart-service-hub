...
const navItems = [
  ...
  { icon: ClipboardList, label: "My Jobs", href: "/technician/jobs" },
  { icon: Clock, label: "In Progress", href: "/technician/in-progress" },
  { icon: CheckCircle, label: "Completed", href: "/technician/completed" },
...
export function TechnicianLayout() {
  ...
  const isActive = (href: string) => {
    if (href === "/technician") return location.pathname === "/technician";
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="lg:hidden sticky top-0 z-50 flex h-16 items-center justify-between border-b bg-card px-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-heading text-lg font-bold">SSK Tech</span>
        </div>
        <div className="flex items-center gap-2">
